...
/*
    Here, I am not using innerHtml for the entire block because, the forst span: desc will contain 
    input from the user. So it is not safe to directly put that into innerHTML. But the buttons do
    not have any such issue, so I am usin =g innerHTML here so that we can easily pass params.
 */
function loadList() {
    todolist.innerHTML="";
